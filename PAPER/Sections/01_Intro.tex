...
the protocol, the twenty models we ran under that protocol, and the
...
selections --- the full discussion is in
Sections~\ref{sec:results} and~\ref{sec:conclusions}.
...
overall. Everything is reproducible from the project
