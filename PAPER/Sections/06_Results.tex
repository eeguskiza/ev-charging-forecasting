...
\subsection{Foundation Models: Size vs.\ Performance}
...
The detailed claim about what we beat against published numbers (we
do not, and why) is deferred to Section~\ref{sec:conclusions} so we
